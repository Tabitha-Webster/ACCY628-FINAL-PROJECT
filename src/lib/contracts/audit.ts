...
assigned_technician_id: "Assigned technician",
  ...
  software_markup_pct: "Software markup %",
  equipment_markup_pct: "Equipment markup %",
  reimbursable_cost_policy: "Reimbursable cost policy",
  ...
  after_hours_terms: "After-hours terms",
