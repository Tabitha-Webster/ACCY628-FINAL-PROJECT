...
export function StatusBadge({
  ...
  return (
    <span
      className={`badge inline-flex h-auto min-h-5 w-max shrink-0 items-center justify-center whitespace-nowrap px-2.5 py-1 leading-tight ${statusBadgeClass(status)} ${className}`.trim()}
    >
